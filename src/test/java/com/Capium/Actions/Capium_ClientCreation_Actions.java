...
public class Capium_ClientCreation_Actions {
    ...
    String Filepath = "D:\\Capium_Automation_BK3.0\\Capium_BK_3.0\\src\\test\\resources\\Files\\ClientCreationData.xlsx";
...
//
//            try {
//                WebElement inputBox = ClientLocators.ClientSearch;
//
...
//                       .sendKeys(expectedClientName)
//                       .pause(Duration.ofSeconds(2)) // Wait to allow results to load
//                       .perform();
//
//               
//                WebElement result = ClientLocators.ClickClient;  // e.g., result in dropdown list
//                wait.until(ExpectedConditions.visibilityOf(result));
//
//                String appearingClientName = result.getText().trim();
//
//                // 4. Match and click
//                if (appearingClientName.equalsIgnoreCase(expectedClientName)) {
//                    Log.info("Client '" + expectedClientName + "' matched. Clicking.");
//                    ((JavascriptExecutor) driver).executeScript("arguments[0].click();", result);
//                } else {
//                    Log.warn("Search returned '" + appearingClientName + "', expected '" + expectedClientName + "'");
//                }
//
//            } catch (TimeoutException e) {
//                Log.error("Client '" + expectedClientName + "' not found in dropdown within timeout.");
//            } catch (Exception e) {
//                e.printStackTrace();
//                Log.error("Unexpected error while interacting with client search: " + e.getMessage());
//            }
//
//            Thread.sleep(1000);
//        }
